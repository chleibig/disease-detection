...
python scripts/convert_JF.py --directory=$path/raw --convert_directory=$path/JF_BG_512 --crop_size=512 --n_proc=$(nproc) --enhance_contrast
...
python scripts/append_img_dim.py -l $path/messidor_R0vsR1.csv -p $path/raw -e tif
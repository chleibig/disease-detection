...
def jeffrey_df(input_var=None, width=512, height=512,
               filename=None, n_classes=5, batch_size=None,
               untie_biases=True):
    """Jeffrey de Fauw's network but with all fc layers converted to conv
       layers.

       * Applicable to arbitrarily sized images.
       * Additional output 'conv_combined' inspired by Zheng et al. (2016):
    ...
    untie_biases : (default: True)
        if set to False and weights are loaded the spatial mean is taken for
